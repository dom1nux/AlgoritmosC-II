...
public class Suma_Matr_Main {
    public static void Main_1() {
        ...
        System.out.print("Ingresa la longitud de la primer matriz: ");
        l1 = Ss.nextInt();
        System.out.print("Ingresa el ancho de la primer matriz: ");
        h1 = Ss.nextInt();
        System.out.print("Ingresa la longitud de la segunda matriz: ");
        l2 = Ss.nextInt();
        System.out.print("Ingresa el ancho de la segunda matriz: ");
        h2 = Ss.nextInt();
