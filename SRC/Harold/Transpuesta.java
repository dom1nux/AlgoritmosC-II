...
public class Transpuesta {
    public static void Main_4() {
        ...
        System.out.println("Ingresa la filas de la matriz A:");
        l1 = Ss.nextInt();
        System.out.println("Ingresa el columnas de la matriz A:");
        h1 = Ss.nextInt();
        System.out.println("Ingresa la filas de la matriz B:");
        l2 = Ss.nextInt();
        System.out.println("Ingresa el columnas de la matriz B:");
        h2 = Ss.nextInt();
        System.out.println("Ingresa la filas de la matriz C:");
        l3 = Ss.nextInt();
        System.out.println("Ingresa el columnas de la matriz C:");
        h3 = Ss.nextInt();
        System.out.println();
